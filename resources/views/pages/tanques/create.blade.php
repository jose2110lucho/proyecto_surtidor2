                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="codigo" class="form-control my-colorpicker1" value="{{ old('codigo') }}">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="cantidad_disponible" class="form-control my-colorpicker1" type="number" value="{{ old('cantidad_disponible') }}" step=".01" min="0">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="cantidad_min" class="form-control my-colorpicker1" type="number" value="{{ old('cantidad_min') }}" step=".01" min="0">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="capacidad" class="form-control my-colorpicker1" type="number" value="{{ old('capacidad') }}" step=".01" min="0" required>
